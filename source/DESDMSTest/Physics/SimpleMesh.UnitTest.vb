...
Public Class SimpleMeshTests
    ...
    <TestMethod()> _
    Public Sub Constructor0()

        Dim myMesh As New SimpleMesh(0.0, 100.0, 1000)

        Assert.AreEqual(100.0, myMesh.R(999), 0.000001)
    ...
    Public Sub Type()
        ...
        Assert.IsTrue(myMesh.Type = MeshType.Simple)
    ...
    <TestMethod()> _
    Public Sub ForEach01()

        Dim myMesh As New SimpleMesh(0.0, 100.0, 1000)

        Dim counter As Integer = 0
        For Each value As Double In myMesh
            counter += 1
        Next
        Assert.AreEqual(myMesh.Count, counter)
    ...
    Public Sub Count01()
        ...
        Assert.AreEqual(1000, myMesh.Count)

    End Sub

    <TestMethod()> _
    Public Sub SinglePointMesh01()

        Dim myMesh As New SimpleMesh(1.0, 1.0, 1)

        Assert.AreEqual(1.0, myMesh.R(0))

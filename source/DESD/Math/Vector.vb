...
Namespace Math
    ...
    Public Class Vector
        ...
        Private mComponents(2) As Double
...
#Region "Constructors"
        ...
        ''' <remarks></remarks>
        Sub New(ByVal componentX As Double, ByVal componentY As Double, ByVal componentZ As Double)
            mComponents(0) = componentX
            mComponents(1) = componentY
            mComponents(2) = componentZ
        End Sub

        Sub New(ByVal cartesianarray As Double())
...
#Region "Shared Methods"
        ...
        Public Shared Function Abs(ByVal v As Vector) As Double
            Return System.Math.Sqrt(v.X * v.X + v.Y * v.Y + v.Z * v.Z)
        End Function

        Public Shared Function Clone(ByVal v As Vector) As Vector
            Return New Vector(v.X, v.Y, v.Z)
        End Function

        Public Shared Function NewFromSpherical(ByVal r As Double, ByVal theta As Double, ByVal phi As Double) As Vector
            Dim retval As New Vector
            retval.SetValuesSpherical(r, theta, phi)
            Return retval
        End Function

        Public Shared Function ScalarProduct(ByVal v1 As Vector, ByVal v2 As Vector) As Double
            Return v1.X * v2.X + v1.Y * v2.Y + v1.Z * v2.Z
        End Function

        Public Shared Function CrossProduct(ByVal v1 As Vector, ByVal v2 As Vector) As Vector
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Shared Function AngleBetween(ByVal v1 As Vector, ByVal v2 As Vector) As Double
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Shared Function EulerAngles(ByVal v1 As Vector, ByVal v2 As Vector) As Double()
